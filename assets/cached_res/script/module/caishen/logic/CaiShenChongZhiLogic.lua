module("CaiShenChongZhiLogic",package.seeall)
...
local function initLayer()
	view = cocostudio.createView("CaiShenChongZhi.json")
	local gui = GUI_CAISHENCHONGZHI
...
function createView()
	...
	Button_ChongZhi = cocostudio.getUIButton(view, "Button_ChongZhi")

	local lable = cocostudio.getUILabel(view,"Label_Info")
	lable:setText(CaiShenLogic.CaiShenInformationTable.caishenchongzhiNotice)
end
...
function callback_BackButton(component)
	...
	elseif component == RELEASE_UP then
		...
		local function actionOver()
			mvcEngine.destroyModule(GUI_CAISHENCHONGZHI)
		end

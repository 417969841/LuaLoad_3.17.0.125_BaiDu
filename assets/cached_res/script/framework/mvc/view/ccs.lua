...
Load.LuaRequire("script.framework.mvc.view.CCNodeExtend")
Load.LuaRequire("script.framework.mvc.view.CCSWidgetExtend")
Load.LuaRequire("script.framework.mvc.view.CCSLayerExtend")
Load.LuaRequire("script.framework.mvc.view.CCSLayoutExtend")
